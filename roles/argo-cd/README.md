...
![Version: 10.8.0](https://img.shields.io/badge/Version-10.8.0-informational?style=flat-square)

The role performs various tasks related to `argo-cd` [chart](https://github.com/argoproj/argo-helm/tree/argo-cd-10.8.0/charts/argo-cd) deployment, reset and validation. Review the [documentation](https://axivo.com/k3s-cluster/wiki/guide/configuration/roles/argocd), for additional details.
...
|------------|------|---------|
| https://github.com/argoproj/argo-cd | argocd | 3.1.8 |
...
| argocd_vars.kubernetes.helm.chart.version | string | `"v10.8.0"` | Helm chart version |
...
| argocd_vars.release.version | string | `"v3.1.8"` | CLI version to install |
