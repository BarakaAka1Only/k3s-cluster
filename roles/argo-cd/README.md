...
![Version: 9.3.7](https://img.shields.io/badge/Version-9.3.7-informational?style=flat-square)

The role performs various tasks related to `argo-cd` [chart](https://github.com/argoproj/argo-helm/tree/argo-cd-9.3.7/charts/argo-cd) deployment, reset and validation. Review the [documentation](https://axivo.com/k3s-cluster/wiki/guide/configuration/roles/argocd), for additional details.
...
| argocd_vars.kubernetes.helm.chart.version | string | `"v9.3.7"` | Helm chart version |
