...
![Version: 10.9.0](https://img.shields.io/badge/Version-10.9.0-informational?style=flat-square)

The role performs various tasks related to `argo-cd` [chart](https://github.com/argoproj/argo-helm/tree/argo-cd-10.9.0/charts/argo-cd) deployment, reset and validation. Review the [documentation](https://axivo.com/k3s-cluster/wiki/guide/configuration/roles/argocd), for additional details.
...
| argocd_vars.kubernetes.helm.chart.version | string | `"v10.9.0"` | Helm chart version |
