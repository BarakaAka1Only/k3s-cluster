...
|------------|------|---------|
| https://prometheus-community.github.io/helm-charts | prometheus-operator-crds | 26.0.1 |
...
| victoriametrics_vars.kubernetes.helm.chart.prometheus.version | string | `"v26.0.1"` |  |
