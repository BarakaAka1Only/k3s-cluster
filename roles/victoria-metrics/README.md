...
|------------|------|---------|
| https://prometheus-community.github.io/helm-charts | prometheus-operator-crds | 27.0.1 |
...
| victoriametrics_vars.kubernetes.helm.chart.prometheus.version | string | `"v27.0.1"` |  |
