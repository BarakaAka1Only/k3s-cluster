...
|------------|------|---------|
| https://prometheus-community.github.io/helm-charts | prometheus-operator-crds | 30.0.1 |
...
| victoriametrics_vars.kubernetes.helm.chart.prometheus.version | string | `"v30.0.1"` |  |
