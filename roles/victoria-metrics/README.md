...
|------------|------|---------|
| https://prometheus-community.github.io/helm-charts | prometheus-operator-crds | 29.0.0 |
...
| victoriametrics_vars.kubernetes.helm.chart.prometheus.version | string | `"v29.0.0"` |  |
