...
|------------|------|---------|
| https://prometheus-community.github.io/helm-charts | prometheus-operator-crds | 32.0.1 |
...
| victoriametrics_vars.kubernetes.helm.chart.prometheus.version | string | `"v32.0.1"` |  |
